...
class Multi_FSB_BTS_UNet(nn.Module):
    """
    ...
    def __init__(self, sequences, regions, width, deep_supervision):
        super(Multi_FSB_BTS_UNet, self).__init__()
    ...
    def forward(self, x):
        ...
        if self.deep_supervision:
            ...
            return predicted_class, [output3, output2, out_npl1, out_npl2, out_npl3, out_npl4, input1, output1]  # 0.8215269708075569
        else:
            output1 = self.output1(d1)
...
if __name__ == "__main__":
    ...
    model = Multi_FSB_BTS_UNet(sequences=1, regions=1, width=6, deep_supervision=False)
